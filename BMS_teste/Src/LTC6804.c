...
static const uint16_t ADDRESSED_COMMANDS_TABLE[6][8] = {{
		...
		0xA004, //READ  S2 V_GROUP A
		0xA006, //READ  S2 V_GROUP B
		0xA008, //READ  S2 V_GROUP C
		0xA00A, //READ  S2 V_GROUP D
		0xA00C, //READ  S2 T_GROUP A
		0xA00E, //READ  S2 T_GROUP B
		0xA002, //READ  S2 CONFIG
		0xA001	//WRITE S2 CONFIG
},{
		0xA804, //READ  S3 V_GROUP A
		0xA806, //READ  S3 V_GROUP B
		0xA808, //READ  S3 V_GROUP C
		0xA80A, //READ  S3 V_GROUP D
		0xA80C, //READ  S3 T_GROUP A
		0xA80E, //READ  S3 T_GROUP B
		0xA802, //READ  S3 CONFIG
		0xA801  //WRITE S3 CONFIG
}
};
